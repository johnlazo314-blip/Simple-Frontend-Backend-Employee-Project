  ...
  return (
    <div style={{ margin: 20 }}>
      ...
      <table border="1" cellPadding="8">
        <thead>
          <tr>
            <th>ID</th><th>First</th><th>Last</th><th>Email</th><th>Birthdate</th><th>Salary</th>
            <th>Actions</th>
            </tr>
            </thead>
        <tbody>
      ...
      <form onSubmit={onSubmit} style={{ marginBottom: 20 }}>
        ...
        {editingId && <button onClick={() => { setEditingId(null); setForm({first_name:'', last_name:'', email:'', birthdate:'', salary:''}) }}>Cancel</button>}
      </form>
